...
void GameObject::UpdateDirectionVectors()
{
	...
	XMMATRIX vecRotationMatrixNoY = XMMatrixRotationRollPitchYaw(0.0, this->rot.y, 0.0);
	this->vec_forward_noY = XMVector3TransformCoord(this->DEFAULT_FORWARD_VECTOR, vecRotationMatrixNoY);
	this->vec_backward = XMVector3TransformCoord(this->DEFAULT_BACKWARD_VECTOR, vecRotationMatrixNoY);
